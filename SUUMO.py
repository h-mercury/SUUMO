...
for properti_details in properties_details:
    ...
    #unit_descriptions = soup.find_all('td', class_='detailbox-property-col detailbox-property--col3')
    #address = soup.find_all('td', class_='detailbox-property-col')
    #distance_from_NU_station = soup.find_all('div', attrs={'style':'font-weight:bold'}) 
